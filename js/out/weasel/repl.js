...
}catch (e16803){if((e16803 instanceof Error)){
var e = e16803;
...
repl_print.cljs$lang$applyTo = (function (arglist__16804){
...
console_print.cljs$lang$applyTo = (function (arglist__16805){
...
var G__16806__delegate = function (args){
...
var connect__delegate = function (repl_server_url,p__16808){
...
var print = cljs.core.get.call(null,map__16811__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__16811__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__16811__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__16811__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__16811__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__16811,map__16811__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__16811,map__16811__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__16811,map__16811__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__16812 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__16812__$1;
var op = cljs.core.get.call(null,map__16812__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__16811,map__16811__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__16811,map__16811__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__16811,map__16811__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
if (arguments.length > 1) {
  p__16808 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return connect__delegate.call(this,repl_server_url,p__16808);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__16813){
var repl_server_url = cljs.core.first(arglist__16813);
var p__16808 = cljs.core.rest(arglist__16813);
return connect__delegate(repl_server_url,p__16808);
});
